...
class Actor_att1(nn.Module):
    def __init__(self, args, with_action = False):
        ...
        en_encoder = nn.Sequential()
        en_encoder.add_module('en_coder1',nn.Linear(self.self_size, self.num_units))
        en_encoder.add_module('en_coder2',nn.Linear(self.num_units, hidden_dim))
        en_encoder.add_module('en_af',nn.LeakyReLU())
