...
class Drone:
    ...
    def __init__(self, id):
        ...
        self.Tm = 1
        self.alpha = 100 #300 6000
        self.kd = 30 #default 30
    ...
    def bacterium_controller(self,nearest_dis,closest_wall,obj):
        ...
        # print(self.current_concentration)
        self.dP_dt = self.kd/((self.kd + self.current_concentration)*(self.kd + self.current_concentration)) * (self.dC_dt+self.current_concentration)
        ...
        self.T = self.T0 * np.exp(self.alpha * self.dP_dt_weight)
        # print(self.T)
    ...
    def obstacle_detection(self):
        ...
        if self.agent.left_sensor.read()[0] != -1:
            ...
            dt = 0.05
            self.left_distance_rate = left_distance/dt
        ...
        if self.agent.right_sensor.read()[0] != -1:
            ...
            dt = 0.05
            self.right_distance_rate = right_distance/dt
        ...
        if self.agent.front_sensor.read()[0] != -1:
            ...
            dt = 0.05
            self.front_distance_rate = front_distance/dt
        ...
        if self.agent.back_sensor.read()[0] != -1:
            ...
            dt = 0.05
            self.back_distance_rate = back_distance/dt
    ...
    def command_generate(self,pos):
        ...
        # print(v_coh[0], v_sep[0], v_frict[0])
        # print(v_mig)
